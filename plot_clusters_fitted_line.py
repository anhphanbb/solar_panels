...
def fit_line_through_centroids(averaged_mlsp, threshold, orbit_number, num_clusters=2):
    ...
    ax.set_title(f"3D Clusters of MLSP > {threshold:.2f} with Fitted Lines (Orbit {orbit_number})", fontsize=16)
...
# Fit lines through centroids of the largest clusters
fit_line_through_centroids(averaged_mlsp, threshold, orbit_number, num_clusters=5)
