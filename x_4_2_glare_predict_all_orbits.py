...
def process_orbit_folder(orbit_folder, orbit_number, batch_size=1024, avg_window_size=9):
...
def process_all_orbits(input_folder, batch_size=1024, avg_window_size=1):
...
# Run the script
process_all_orbits(input_folder, batch_size=256, avg_window_size=1)
